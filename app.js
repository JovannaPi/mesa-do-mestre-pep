...
function seedAmbientes() {
  if (state.seededAmbientes) return;
  state.seededAmbientes = true;
  const notes = [
    { id: uid(), titulo: "Ambientes — Ato 1: Cervovale", texto: "A vila ainda parece aconchegante e habitada — mas a maldição doce já deixou sinais: um brilho rosado e açucarado na madeira, cristais lilás crescendo num canto, poeira de açúcar onde não deveria haver.\n\n📍 Prefeitura (tem mapa próprio)\nCasarão de dois andares numa colina, com vista pra vila. Seis cômodos modestos, madeira escura e papel envelhecido.\nPiso: tábuas de madeira escura, um tapete surrado no gabinete principal.\n\n1. Salão de entrada — tem: um quadro de avisos, um banquinho\n2. Gabinete de Teodoro — tem: uma mesa cheia de papéis, uma cadeira alta\n   🔎 Se investigarem: Achado: \"Carta de Selene para Teodoro\", escondida numa gaveta.\n3. Sala de reuniões — tem: uma mesa comprida, cadeiras avulsas\n4. Arquivo — tem: prateleiras de fichas de moradores, uma gaveta trancada\n   🔎 Se investigarem: Achado: \"Lista dos Moradores\".\n5. Depósito — tem: caixotes empilhados, uma lanterna velha\n6. Sala antiga da guarda — tem: um suporte de armas vazio, um mapa desbotado na parede\n\n📍 Padaria do Geraldo (tem mapa próprio)\nPadaria de vila com casa conjugada, calorosa e familiar, cheirando a pão.\nPiso: piso de madeira clara na loja, ladrilho na cozinha.\n\n1. Salão da padaria — tem: um balcão de madeira, uma prateleira com pães\n2. Balcão — tem: uma caixa de dinheiro, uma pequena balança\n3. Cozinha — tem: uma mesa grande de amassar, panelas penduradas\n   🔎 Se investigarem: Achado: \"Receita do Padeiro\" pregada na parede (e a nota de Geraldo sobre o açúcar vermelho que ele não sabe de onde vem).\n4. Área do forno — tem: dois fornos de tijolo, lenha empilhada\n5. Estoque — tem: sacos de farinha, uma prateleira de receitas\n6. Quarto de Rui — tem: uma cama pequena, brinquedos de madeira espalhados\n   🔎 Se investigarem: Achado (se procurarem entre os brinquedos): \"Página do Diário de uma Criança\".\n\n📍 Pousada A Cabra Sorridente (tem mapa próprio)\nPousada rústica, salão principal com mesas e um corredor lateral levando aos quartos.\nPiso: tábuas largas de madeira escura, tapete redondo trançado perto da lareira.\n\n1. Salão — tem: mesas de madeira, uma lareira de pedra\n2. Recepção / balcão — tem: um sino de mesa, um livro de hóspedes\n3. Cozinha — tem: um fogão, panelas penduradas\n4. Depósito — tem: barris, sacos de suprimentos\n5. Corredor dos quartos — tem: uma fileira de portas, uma única lamparina de parede\n6. Quarto do proprietário — tem: uma cama simples, um guarda-roupa\n7. Quarto genérico de hóspedes — tem: uma cama, um baú pequeno, uma janela\n\n📍 Loja / Armazém de Zeca\nArmazém de trocas pequeno e desorganizado, prateleiras lotadas até o teto.\nPiso: piso de madeira gasto, coberto por tapetes remendados.\n\n1. Área de vendas — tem: prateleiras de mercadorias variadas, uma mesinha de bugigangas\n2. Balcão — tem: uma caixa registradora antiga, um livro-caixa\n3. Estoque — tem: caixas empilhadas, ferramentas sobrando\n4. Depósito — tem: caixotes vindos da floresta, um armário empoeirado\n\n📍 Ferraria da Maya (tem mapa próprio)\nFerraria funcional e organizada — o único lugar da vila que parece sob controle.\nPiso: piso de pedra irregular na oficina, tábuas no escritório.\n\n1. Oficina principal — tem: uma bigorna central, ferramentas penduradas\n2. Fornalha — tem: uma fornalha acesa, um fole\n3. Bancada — tem: uma lâmina inacabada, peças espalhadas\n4. Depósito de metais — tem: barras de metal empilhadas, um barril de sobras\n5. Sala de ferramentas — tem: ferramentas na parede, uma pedra de amolar\n6. Pequeno escritório — tem: uma mesa, um xale dobrado numa prateleira\n   🔎 Se investigarem: Achado: \"Bilhete de Maya\" (endereçado a Élton).\n\n📍 Loja de Poções de Rosa (tem mapa próprio)\nLoja pequena cheia de frascos e ervas secas — prateleiras atrás do balcão visivelmente vazias em alguns pontos.\nPiso: piso de madeira manchado por poções derramadas.\n\n1. Loja — tem: um balcão de madeira, prateleiras de frascos\n2. Laboratório — tem: um caldeirão pequeno borbulhando sozinho, ervas penduradas\n3. Sala de mistura — tem: uma mesa de mistura, frascos de vidro\n4. Depósito de ingredientes — tem: potes etiquetados, feixes de ervas secas\n5. Sala de experimentos — tem: um caderno aberto, anotações espalhadas\n\n📍 Sala da Guarda\nPequeno posto da guarda da vila, funcional e severo.\nPiso: piso de pedra simples.\n\n1. Recepção — tem: uma mesa, um quadro de avisos na parede\n   🔎 Se investigarem: Achado: \"Aviso da Guarda\" (assinado por Selene, com uma frase acrescentada depois, em letra diferente).\n2. Sala dos guardas — tem: uma mesa, alguns banquinhos\n3. Arsenal — tem: um suporte de lanças e escudos\n   🔎 Se investigarem: Achado: \"Sino da Guarda\", pendurado entre as armas — parece comum até alguém tocá-lo três vezes de madrugada.\n4. Arquivo — tem: pastas de relatórios empilhadas\n   🔎 Se investigarem: Achado: \"Relatório da Noite da Bruxa\".\n5. Sala de mapas — tem: um grande mapa regional, uma mesa\n6. Cela — tem: um catre simples, grades de ferro\n\n📍 O Poço da Praça (tem mapa próprio)\nPraça central da vila, centrada num poço de pedra antigo — é aqui que as 3 relíquias precisam ser jogadas pra quebrar a maldição.\nPiso: calçamento de pedra irregular.\n\n1. Praça ao redor — tem: calçamento de pedra, um banco\n   🔎 Se investigarem: Achado (se alguém passar a noite ali e prestar atenção): \"Bala que Nunca Derrete\", encontrada entre as pedras.\n2. Boca do poço — tem: a borda de pedra do poço, um balde numa corda\n3. Interior do poço — tem: um poço de pedra descendo na escuridão\n4. Estrutura subterrânea — tem: degraus de pedra antigos, musgo com um brilho fraco", categoria: "ambientes" },
    { id: uid(), titulo: "Ambientes — Ato 2: Bosque Emaranhado", texto: "A floresta é antiga, invasiva e ligeiramente errada — raízes rompendo pedra, musgo tingido de um brilho violeta anti-natural, uma quietude estranha no ar.\n\n📍 Acampamento Abandonado (esconderijo de Selene)\nUm pequeno acampamento de exploradores numa clareira — sem paredes, delimitado por troncos caídos. Selene anda usando esse lugar escondida.\nPiso: terra batida e folhas secas, raízes expostas cruzando o chão.\n\n1. Área das fogueiras — tem: uma fogueira apagada há dias, galhos carbonizados\n2. Tenda destruída — tem: uma tenda rasgada, um suporte caído\n   🔎 Se investigarem: Achado: \"Página de Selene\" — confirma que ela está viva.\n3. Área de suprimentos — tem: suprimentos mofados e espalhados\n   🔎 Se investigarem: Achado (se Rui foi salvo e trazido aqui, ou se procurarem rastros dele): \"Bilhete de Rui\".\n4. Clareira — tem: grama rala, pegadas confusas na terra\n5. Trilha de saída — tem: uma trilha estreita de terra, arbustos baixos\n\n📍 Ruínas Antigas (tem mapa próprio)\nRuínas de pedra cobertas de vegetação, arquitetura antiga parcialmente desmoronada.\nPiso: lajes de pedra rachadas, raízes rompendo o chão em vários pontos.\n\n1. Entrada — tem: colunas quebradas\n2. Salão principal — tem: escombros caídos, piso rachado\n   🔎 Se investigarem: Achado: \"Diário do Explorador\" — relatos de alguém que se perdeu andando em círculos.\n3. Corredor — tem: paredes cobertas de musgo\n4. Câmara do altar — tem: um altar de pedra coberto de musgo\n5. Sala lateral — tem: escombros, uma estátua quebrada\n6. Escadaria — tem: degraus de pedra gastos\n7. Porão — tem: escuridão total, entalhes fracos na parede\n\n📍 Círculo dos Cogumelos (tem mapa próprio)\nClareira circular perfeita na floresta, sete cogumelos gigantes coloridos formando um anel ao redor de uma pedra ereta — Ashkan está preso lá dentro.\nPiso: grama luminescente salpicada de esporos brilhantes.\n\n1. Floresta externa — tem: árvores densas, samambaias baixas\n2. Círculo de cogumelos — tem: sete cogumelos gigantes de cores diferentes\n3. Pedra de Ashkan — tem: uma pedra ereta entalhada com símbolos arcanos\n   🔎 Se investigarem: Achado (se explorarem ao redor da pedra): \"Chave Sem Fechadura\" — só serve mais tarde, no Baile Eterno.\n4. Área central — tem: esporos brilhantes no chão\n\n📍 Caverna do Espelho (tem mapa próprio)\nSistema de cavernas úmidas e sinuosas cortadas na rocha, ficando progressivamente mais estranhas e profundas.\nPiso: rocha úmida e escorregadia, poças rasas d'água refletindo luz azul-esverdeada.\n\n1. Entrada — tem: trepadeiras penduradas, rocha úmida\n2. Túnel estreito — tem: estalactites pingando\n3. Câmara dos ecos — tem: paredes de rocha lisas e curvas\n4. Lago subterrâneo — tem: um lago perfeitamente parado e reflexivo\n5. Câmara do espelho — tem: cacos de espelho embutidos na rocha\n   🔎 Se investigarem: Achado: \"Espelho Rachado\" — mostra uma cena que pode acontecer, nunca diga se é o futuro garantido.\n6. Sala de recarga — tem: símbolos gravados brilhando no chão\n7. Câmara profunda — tem: água parada no escuro, uma luz fraca ao fundo\n   🔎 Se investigarem: Achado (bem escondido): \"Receita de Poção\" (de memória) gravada numa pedra.\n\n📍 Lago da Saudade Eterna (tem mapa próprio)\nLago mágico perfeitamente circular, água cristalina azul-violeta profunda, sem fundo visível — o portal secreto pro Baile Eterno.\nPiso: areia fina na praia, pedras arredondadas nas margens, a própria água como piso central.\n\n1. Margem — tem: pedras lisas ao longo da beira\n   🔎 Se investigarem: Achado: uma \"Fita Vermelha\" presa a um galho — quem segura sente uma lembrança que não é sua.\n2. Praia — tem: areia fina e clara\n3. Área das pedras — tem: pedras planas espalhadas\n4. Água rasa — tem: água clara e parada\n5. Centro do lago — tem: uma luz suave e hipnótica vindo de baixo d'água\n   🔎 Se investigarem: Ativa o portal pro Baile Eterno se quem entrar carregar um item de origem feérica.", categoria: "ambientes" },
    { id: uid(), titulo: "Ambientes — Ato 3: Vale das Bagas", texto: "Charmoso e em escala miniatura, construído por e para fadas — arquitetura orgânica arredondada em tons de mel-rosado e magenta, encantadora mas com uma corrupção vermelho-escura se espalhando pelo mel.\n\n📍 Praça das Fadas (tem mapa próprio)\nPracinha de vila feérica em escala miniatura, casas esculpidas em cogumelos gigantes ao redor de uma árvore central.\nPiso: terra batida polvilhada de pétalas, pedrinhas arredondadas formando caminhos.\n\n1. Praça — tem: caminhos de pedrinhas, chão coberto de pétalas\n2. Fonte de mel — tem: uma fonte pequena escorrendo mel dourado\n   🔎 Se investigarem: Achado: \"Semente Azul\" caída perto da fonte — só floresce quando alguém diz uma verdade.\n3. Árvore central — tem: um tronco gigante com portas e janelas esculpidas\n4. Mercado — tem: barraquinhas coloridas\n5. Pequeno palco — tem: uma plataforma de madeira improvisada\n\n📍 Palácio da Rainha Gardênia (tem mapa próprio)\nPalácio esculpido diretamente nas raízes de uma árvore gigantesca ainda viva e florida.\nPiso: madeira polida com veios dourados, tapetes de pétalas prensadas na sala do trono.\n\n1. Entrada — tem: um caminho de pétalas\n2. Salão principal — tem: pilares de madeira entalhada\n3. Sala do trono — tem: um trono de madeira viva coberto de flores\n   🔎 Se investigarem: Achado: placa com \"O Juramento da Colher\" perto do trono.\n4. Arquivo — tem: prateleiras de pergaminhos\n   🔎 Se investigarem: Achado: \"Carta da Rainha Gardênia\" — conta como Dulcineia roubou a Colher de Mel.\n5. Jardim — tem: canteiros internos luminosos\n6. Sala da Colher de Mel — tem: uma vitrine reverente e vazia\n   🔎 Se investigarem: Achado: \"Colher de Madeira\" — uma réplica com a marca \"D\" entalhada.\n7. Quarto da Rainha — tem: uma cama com dossel, tecidos macios\n8. Sala privada — tem: uma mesinha, uma única cadeira\n\n📍 Mercado das Fadas\nPequeno mercado feérico coberto, barracas de madeira e tecido coloridas lado a lado.\nPiso: tábuas de madeira irregulares, tapetes trançados sob cada barraca.\n\n1. Mercado principal — tem: fileiras de barraquinhas\n2. Barracas — tem: toldos remendados\n   🔎 Se investigarem: Achado: \"Bilhete de uma Fada\" avisando sobre o rato que \"sabe seus nomes\".\n3. Loja de ingredientes — tem: potes de ingredientes mágicos empilhados\n4. Loja de poções — tem: frascos brilhando fracamente, pendurados\n5. Área de comerciantes — tem: uma balança, caixotes pequenos\n\n📍 A Colmeia (tem mapa próprio)\nColmeia gigante escavada, paredes hexagonais de cera pingando mel espesso demais pra ser natural.\nPiso: cera endurecida e pegajosa, poças de mel em alguns pontos.\n\n1. Entrada — tem: um arco arredondado de cera\n2. Túnel de mel — tem: paredes de favo pingando\n3. Câmara de armazenamento — tem: células cheias de mel empilhadas\n   🔎 Se investigarem: Achado: \"Registro da Colmeia\" — mostra que a produção de mel ficou impossível no outono.\n4. Câmara das abelhas — tem: células hexagonais de cera bem densas\n5. Câmara da rainha — tem: uma plataforma elevada de cera\n6. Túnel lateral — tem: paredes estreitas e pingando\n7. Câmara contaminada — tem: um chão escuro e rachado, indo em direção à toca do Rei Rato\n8. Saída secreta — tem: uma passagem estreita e escondida\n\n📍 Armazém / Depósito de Comida (tem mapa próprio)\nArmazém subterrâneo de comida das fadas pequenas, convertido de uma antiga toca.\nPiso: terra compactada, restos de cera e mel grudentos em pontos.\n\n1. Entrada — tem: um simples batente de madeira\n2. Depósito de comida — tem: estoques de comida devorados e espalhados\n3. Sala das poções — tem: um miasma colorido pairando no ar\n4. Armaria — tem: suportes de armas enferrujados\n5. Sala das abelhas — tem: prateleiras cobertas de favo de mel\n   🔎 Se investigarem: Achado: \"Receita de Mel\" (das fadas) — cura pequenas corrupções ou ganha confiança das fadas.\n6. Depósito secundário — tem: caixotes empilhados\n7. Entrada dos túneis — tem: uma abertura estreita e escura\n\n📍 Túneis do Rei Rato (tem mapa próprio)\nTúneis escavados às pressas por garras desesperadas, estreitando e bifurcando sem padrão claro, até uma câmara final maior.\nPiso: terra irregular, poças de mel rançoso e água parada em pontos mais baixos.\n\n1. Entrada — tem: uma abertura escavada estreita\n   🔎 Se investigarem: Achado: \"Pequeno Dente de Rato\" — sussurra \"Ainda lembro\" perto do Rei Rato.\n2. Túnel principal — tem: paredes de terra com marcas de garras\n3. Bifurcação — tem: dois caminhos divergentes\n4. Toca pequena — tem: pelo grudado, restos de comida\n5. Depósito roubado — tem: comida roubada empilhada\n6. Túnel inundado — tem: água parada rasa\n7. Câmara dos ninhos — tem: ninhos tecidos com detritos\n8. Câmara do Rei Rato — tem: uma massa pulsante de formas de rato fundidas — o Rei Rato", categoria: "ambientes" },
    { id: uid(), titulo: "Ambientes — Ato 4: Baile Eterno", texto: "Suntuoso, interminável e sutilmente enganoso — espelhos que refletem errado, lustres com velas demais, uma beleza rosa-violeta que parece congelada num único instante sem fim.\n\n📍 Jardim do Amanhecer (tem mapa próprio)\nJardim de fadas altas suspenso num eterno amanhecer rosado, seis áreas conectadas por caminhos sinuosos.\nPiso: grama aparada com precisão impossível, caminhos de pedra branca polida.\n\n1. Entrada — tem: um portão de jardim ornamentado\n   🔎 Se investigarem: Achado (preso ao portão): \"Convite para o Baile\" — o baile começa ao anoitecer e não termina.\n2. Jardim principal — tem: roseiras perfeitas demais pra serem reais\n3. Fonte — tem: uma fonte de mármore com veios dourados\n4. Gazebo — tem: um gazebo branco rendado\n5. Labirinto de flores — tem: um pequeno labirinto de sebes floridas\n6. Ponte — tem: uma ponte ornamentada sobre um riacho raso\n\n📍 Salão do Banquete (tem mapa próprio)\nSalão de banquete sob um céu eterno de meio-dia, uma mesa impossivelmente longa dominando o centro.\nPiso: mármore polido em tabuleiro dourado e violeta.\n\n1. Entrada — tem: portas duplas douradas e altas\n   🔎 Se investigarem: Achado: \"Manual de Etiqueta do Baile\" — nunca prometa voltar, nunca pergunte há quanto tempo alguém está ali.\n2. Salão principal — tem: uma mesa de banquete impossivelmente longa\n3. Mesas — tem: fileiras de cadeiras de jantar\n   🔎 Se investigarem: Achado: \"Lista de Convidados\" — Élton Élis está listado como \"convidado permanente\".\n4. Mesa dos nobres — tem: uma mesa elevada e elegante\n5. Buffet — tem: bandejas de prata\n   🔎 Se investigarem: Achado: \"Taça do Meio-Dia\" — quem bebe sente felicidade absoluta por minutos, depois esquece por que estava triste.\n6. Área dos músicos — tem: um pequeno palco elevado\n7. Varanda — tem: portas de vidro, flores em vasos\n\n📍 Corredores do Palácio\nCorredores palacianos com arquitetura sutilmente impossível — perspectivas que não deveriam se encontrar.\nPiso: tapete magenta profundo correndo por todo o comprimento, mármore visível nas bordas.\n\n1. Corredor principal — tem: espelhos emoldurados em ouro\n2. Escadaria — tem: uma escadaria dupla se curvando de formas estranhas\n3. Corredor dos espelhos — tem: espelhos em ângulos estranhos\n4. Galeria — tem: retratos emoldurados de convidados\n5. Corredor privado — tem: um único banco silencioso\n\n📍 Sala dos Espelhos (tem mapa próprio)\nCâmara circular pequena e desorientadora, forrada de espelhos emoldurados de tamanhos variados.\nPiso: mármore negro polido refletindo os espelhos ao redor.\n\n1. Entrada — tem: um arco estreito espelhado\n2. Espelho central — tem: um espelho grande e ornamentado\n3. Espelhos laterais — tem: espelhos menores em ângulos estranhos\n4. Corredor — tem: uma passagem estreita espelhada\n5. Câmara escondida — tem: um pequeno recanto oculto atrás dos espelhos\n   🔎 Se investigarem: Achado: \"Chave Sem Porta\" — uma cadeira vazia e uma carta: \"Eu também procurei a saída.\"\n\n📍 Grande Salão de Dança (tem mapa próprio)\nO salão mais importante do Baile — uma vasta pista de dança circular sob um céu de estrelas artificiais. É aqui que acontece o desafio social do Rei-Elfo.\nPiso: mármore branco-azulado espelhado no centro, tapetes dourados nas bordas.\n\n1. Entrada — tem: portas altas e ornamentadas\n2. Pista de dança — tem: um piso de mármore refletindo luz de estrelas de lugar nenhum\n3. Palco — tem: uma plataforma elevada e vazia\n   🔎 Se investigarem: Achado (escondido perto do palco): \"Máscara de Porcelana\" — quem a usa é visto como quem os outros esperavam encontrar.\n4. Área dos músicos — tem: suportes de instrumento vazios, sem músicos visíveis\n5. Área dos nobres — tem: assentos estofados\n6. Mesa lateral — tem: uma pequena mesa de refresco\n7. Sacada — tem: um mirante elevado com corrimão\n8. Escadaria — tem: uma grande escadaria curva\n   🔎 Se investigarem: Achado: \"Página do Livro do Rei-Elfo\" — \"um reino perfeito não possui amanhã\".\n\n📍 Ala de Ilayda\nAla privada e vaidosa do palácio, decoração excessiva e cheia de espelhos e retratos da própria dona. Élton está mantido aqui.\nPiso: tapetes felpudos em tons rosa e dourado sobre madeira escura.\n\n1. Sala de recepção — tem: retratos e espelhos em profusão\n2. Sala privada — tem: uma penteadeira, uma chaise\n3. Biblioteca — tem: pequenas prateleiras de curiosidades\n4. Quarto de hóspedes — tem: uma cama elegante mas fria\n   🔎 Se investigarem: É aqui que Élton fica. Achado: \"Carta de Élton para Maya\" — a letra bate com o bilhete que ela guarda em Cervovale.\n5. Varanda — tem: uma vista de jardim com corrimão", categoria: "ambientes" },
    { id: uid(), titulo: "Ambientes — Ato 5: Torre da Bruxa", texto: "Arquitetura de confeitaria torcida — paredes que parecem caramelo endurecido e açúcar queimado tingido de violeta amassado, uma sensação constante de que o doce azedou em horror.\n\n📍 Entrada da Torre (tem mapa próprio)\nBase da torre, um portão imponente de açúcar cristalizado levando a um vestíbulo guardado.\nPiso: pedra coberta por uma fina camada pegajosa de açúcar derretido.\n\n1. Portão — tem: um arco de açúcar cristalizado\n2. Vestíbulo — tem: dois construtos de chocolate com hortelã parados como estátuas\n   🔎 Se investigarem: Senha pra passar sem luta: \"Maçapão Maravilhoso\".\n3. Salão dos constructos — tem: paredes cobertas de caramelo escuro\n4. Escadaria — tem: uma escadaria de pedra em espiral\n5. Corredor — tem: uma passagem estreita vitrificada de doce\n\n📍 Cozinha (tem mapa próprio)\nCozinha encantada e perigosamente viva — os utensílios se mexem sozinhos e atacam quem entra sem permissão.\nPiso: ladrilho escorregadio manchado de melado.\n\n1. Cozinha principal — tem: um caldeirão borbulhando sozinho, sem ninguém mexendo\n2. Fogão — tem: um fogão a lenha\n3. Forno — tem: um forno de tijolo grande\n4. Bancada — tem: facas e utensílios animados\n5. Armários — tem: louças empilhadas\n6. Despensa — tem: potes de doces conservados\n7. Passagem do esgoto — tem: uma grade enferrujada no chão, ligando ao Esgoto\n\n📍 Jardim Mágico (tem mapa próprio)\nJardim interno impossivelmente verdejante, salpicado de flores cristalizadas que brilham como vidro. Alistair está preso aqui, oferecendo a Roleta do Chá.\nPiso: grama artificial perfeita demais, caminho de pedrinhas de açúcar.\n\n1. Entrada — tem: um arco florido que parece de vidro\n2. Canteiros — tem: flores cristalizadas e brilhantes\n3. Fonte — tem: uma fonte pequena com glacê de caramelo\n4. Estufa — tem: painéis de vidro, trepadeiras penduradas\n5. Árvore antiga — tem: uma árvore de casca de doce, torta\n6. Estátuas — tem: figuras de doce imóveis\n7. Área de Alistair — tem: uma mesa de chá posta com um coelho de chocolate branco sentado\n\n📍 Escritório de Dulcineia (tem mapa próprio)\nEscritório abarrotado de livros sem título, organizados ao redor de uma escrivaninha central.\nPiso: tábuas escuras cobertas por um tapete surrado.\n\n1. Entrada — tem: uma porta pesada de madeira\n2. Escrivaninha — tem: um diário aberto, uma pena\n   🔎 Se investigarem: Achado: \"Página do Diário de Dulcineia\" — \"a alma não é fixa... por que insistem que uma pessoa precisa permanecer a mesma?\"\n3. Estante 1 — tem: livros sem título, escritos à mão\n4. Estante 2 — tem: tomos velhos empilhados\n5. Estante 3 — tem: um livro-armadilha escondido\n   🔎 Se investigarem: Achado (se lerem com cuidado): \"Pequeno Caderno Preto\" — \"se alguém encontrar isto, não destrua o ovo\", sem assinatura.\n6. Armário — tem: gavetas trancadas\n7. Espelho — tem: um espelho alto e ornamentado\n\n📍 Laboratório de Experimentos (tem mapa próprio)\nO laboratório mais denso e perigoso da torre, cheio de instrumentos alquímicos.\nPiso: pedra manchada por décadas de derramamentos alquímicos.\n\n1. Entrada — tem: uma porta pesada manchada de produtos químicos\n2. Bancada — tem: frascos, um pilão manchado\n   🔎 Se investigarem: Achado: \"Pena Negra\" — fica quente perto do ovo de dragão.\n3. Mesa de experimentos — tem: um livro de experimentos aberto\n   🔎 Se investigarem: Achado: \"Registro do Experimento\" — \"Experimento 14: sucesso parcial. A consciência permaneceu separada.\"\n4. Círculo mágico — tem: um círculo gravado e brilhante\n5. Estante de frascos — tem: fileiras de frascos etiquetados\n6. Gaiolas — tem: algumas gaiolas pequenas e vazias\n7. Armário — tem: suprimentos alquímicos trancados\n8. Área de experimentação — tem: uma vitrine vazia do tamanho de uma pessoa\n\n📍 Corredor das Celas (tem mapa próprio)\nCorredor estreito ladeado por cinco pequenas celas — onde as crianças roubadas dormiram. Atmosfera pesada e silenciosa.\nPiso: pedra fria e nua, palha espalhada dentro das celas.\n\n1. Corredor — tem: um corredor longo e estreito\n2. Cela 1 — tem: desenhos de criança riscados na parede\n3. Cela 2 — tem: um brinquedo pequeno esquecido\n4. Cela 3 — tem: palha espalhada\n5. Cela 4 — tem: marcas de contagem riscadas na parede\n6. Cela 5 — tem: um catre simples\n7. Sala de observação — tem: uma janela estreita, um banquinho\n8. Escada — tem: degraus gastos descendo\n\n📍 Berçário (tem mapa próprio)\nBerçário perturbador que mistura ternura e horror, culminando numa plataforma central elevada com o ovo do dragão.\nPiso: tábuas de madeira macia, tapetes felpudos claros manchados de algo escuro.\n\n1. Entrada — tem: um vão de porta arredondado e suave\n2. Área dos berços — tem: uma fileira de berços vazios\n3. Armários — tem: cobertores dobrados\n4. Brinquedos — tem: brinquedos macios espalhados\n5. Parede de desenhos — tem: desenhos de crianças pregados na parede\n   🔎 Se investigarem: Achado: \"Lista de Nomes\" — nomes de crianças desaparecidas, alguns riscados, um circulado várias vezes: Rui Silva.\n6. Área central — tem: um pequeno tapete redondo\n   🔎 Se investigarem: Achado: \"Boneca de Açúcar\" — chora quando perto de alguém já transformado em doce.\n7. Plataforma do ovo — tem: uma plataforma elevada sustentando um ovo gigante que pulsa com calor visível\n\n📍 Quarto de Dulcineia (tem mapa próprio)\nQuarto pessoal da bruxa, elegante e perturbador ao mesmo tempo, organizado ao redor de um altar central.\nPiso: tapete espesso vermelho-escuro, tábuas polidas nas bordas.\n\n1. Entrada — tem: uma porta ornamentada\n2. Cama — tem: uma cama com dossel e cortinas escuras\n3. Penteadeira — tem: potes de maquiagem transbordando\n   🔎 Se investigarem: Achado: \"Frasco com Pó Dourado\" — etiqueta \"Memórias — lote 7\", libera uma lembrança se aberto.\n4. Guarda-roupa — tem: um guarda-roupa ornamentado\n5. Baú — tem: um baú pesado e trancado (a chave está na Gosma de Açúcar do dreno)\n   🔎 Se investigarem: Achado dentro do baú: \"Carta Nunca Enviada\" — \"quando o ovo abrir, eles voltarão. Todos. — Dulcineia\".\n6. Estante — tem: alguns livros pessoais\n   🔎 Se investigarem: Achado: \"Instruções do Pingente\" — \"o que for separado deverá encontrar um recipiente.\"\n7. Altar do Pingente — tem: um construto perfeito, parado, com uma luz azul fraca pulsando no peito\n\n📍 Câmara do Ovo / Topo da Torre (tem mapa próprio)\nO ponto mais alto da torre, uma câmara cerimonial aberta com vista pra floresta inteira através de janelas altas.\nPiso: pedra polida em espiral levando ao centro cerimonial.\n\n1. Escadaria — tem: a subida final em espiral\n2. Plataforma central — tem: uma plataforma de pedra elevada\n3. Círculo mágico — tem: um anel gravado e brilhante\n4. Altar — tem: um altar de pedra simples\n   🔎 Se investigarem: Achado (perto do altar): \"Anotação Sobre o Ovo\" — \"se as duas coisas acordarem juntas... não sei qual delas nascerá primeiro.\" Pista importante — não entregue cedo.\n5. Janelas — tem: janelas altas e estreitas deixando entrar luar\n6. Ovo do Dragão — tem: um ovo gigante pulsando com calor visível sobre um pedestal\n\n📍 Esgoto\nSistema de esgoto apertado sob a torre, túneis estreitos e escuros.\nPiso: pedra encharcada e escorregadia, um fio constante de líquido colorido escorrendo pelo centro dos túneis.\n\n1. Entrada externa — tem: uma grade de ferro enferrujada\n2. Túnel — tem: uma passagem estreita e pingando\n3. Bifurcação — tem: dois túneis baixos divergentes\n4. Câmara subterrânea — tem: uma massa disforme no escuro — a Gosma de Açúcar, guardando a chave dourada do baú\n5. Saída para cozinha — tem: uma grade enferrujada no teto, ligando à Cozinha", categoria: "ambientes" },
  ];
  notes.forEach((n) => {
    if (!state.notes.some((x) => x.titulo === n.titulo)) state.notes.push(n);
  });
...
function seedAmbientesV2() {
  if (state.seededAmbientesV2) return;
  state.seededAmbientesV2 = true;
  // v1 juntava tudo por ato (5 notas grandes); trocamos por uma nota por localidade,
  // que é o que ficou combinado — removemos as v1 pra não duplicar conteúdo.
  state.notes = state.notes.filter((n) => !/^Ambientes — Ato \d: /.test(n.titulo));
  const notes = [
    { id: uid(), titulo: "Prefeitura (Cervovale)", texto: "Casarão de dois andares numa colina, com vista pra vila. Seis cômodos modestos, madeira escura e papel envelhecido.\nPiso: tábuas de madeira escura, um tapete surrado no gabinete principal.\n\n1. Salão de entrada — tem: um quadro de avisos, um banquinho\n2. Gabinete de Teodoro — tem: uma mesa cheia de papéis, uma cadeira alta\n   🔎 Se investigarem: Achado: \"Carta de Selene para Teodoro\", escondida numa gaveta.\n3. Sala de reuniões — tem: uma mesa comprida, cadeiras avulsas\n4. Arquivo — tem: prateleiras de fichas de moradores, uma gaveta trancada\n   🔎 Se investigarem: Achado: \"Lista dos Moradores\".\n5. Depósito — tem: caixotes empilhados, uma lanterna velha\n6. Sala antiga da guarda — tem: um suporte de armas vazio, um mapa desbotado na parede", categoria: "ambientes" },
    { id: uid(), titulo: "Padaria do Geraldo (Cervovale)", texto: "Padaria de vila com casa conjugada, calorosa e familiar, cheirando a pão.\nPiso: piso de madeira clara na loja, ladrilho na cozinha.\n\n1. Salão da padaria — tem: um balcão de madeira, uma prateleira com pães\n2. Balcão — tem: uma caixa de dinheiro, uma pequena balança\n3. Cozinha — tem: uma mesa grande de amassar, panelas penduradas\n   🔎 Se investigarem: Achado: \"Receita do Padeiro\" pregada na parede (e a nota de Geraldo sobre o açúcar vermelho que ele não sabe de onde vem).\n4. Área do forno — tem: dois fornos de tijolo, lenha empilhada\n5. Estoque — tem: sacos de farinha, uma prateleira de receitas\n6. Quarto de Rui — tem: uma cama pequena, brinquedos de madeira espalhados\n   🔎 Se investigarem: Achado (se procurarem entre os brinquedos): \"Página do Diário de uma Criança\".", categoria: "ambientes" },
    { id: uid(), titulo: "Pousada A Cabra Sorridente (Cervovale)", texto: "Pousada rústica, salão principal com mesas e um corredor lateral levando aos quartos.\nPiso: tábuas largas de madeira escura, tapete redondo trançado perto da lareira.\n\n1. Salão — tem: mesas de madeira, uma lareira de pedra\n2. Recepção / balcão — tem: um sino de mesa, um livro de hóspedes\n3. Cozinha — tem: um fogão, panelas penduradas\n4. Depósito — tem: barris, sacos de suprimentos\n5. Corredor dos quartos — tem: uma fileira de portas, uma única lamparina de parede\n6. Quarto do proprietário — tem: uma cama simples, um guarda-roupa\n7. Quarto genérico de hóspedes — tem: uma cama, um baú pequeno, uma janela", categoria: "ambientes" },
    { id: uid(), titulo: "Loja / Armazém de Zeca (Cervovale)", texto: "Armazém de trocas pequeno e desorganizado, prateleiras lotadas até o teto.\nPiso: piso de madeira gasto, coberto por tapetes remendados.\n\n1. Área de vendas — tem: prateleiras de mercadorias variadas, uma mesinha de bugigangas\n2. Balcão — tem: uma caixa registradora antiga, um livro-caixa\n3. Estoque — tem: caixas empilhadas, ferramentas sobrando\n4. Depósito — tem: caixotes vindos da floresta, um armário empoeirado", categoria: "ambientes" },
    { id: uid(), titulo: "Ferraria da Maya (Cervovale)", texto: "Ferraria funcional e organizada — o único lugar da vila que parece sob controle.\nPiso: piso de pedra irregular na oficina, tábuas no escritório.\n\n1. Oficina principal — tem: uma bigorna central, ferramentas penduradas\n2. Fornalha — tem: uma fornalha acesa, um fole\n3. Bancada — tem: uma lâmina inacabada, peças espalhadas\n4. Depósito de metais — tem: barras de metal empilhadas, um barril de sobras\n5. Sala de ferramentas — tem: ferramentas na parede, uma pedra de amolar\n6. Pequeno escritório — tem: uma mesa, um xale dobrado numa prateleira\n   🔎 Se investigarem: Achado: \"Bilhete de Maya\" (endereçado a Élton).", categoria: "ambientes" },
    { id: uid(), titulo: "Loja de Poções de Rosa (Cervovale)", texto: "Loja pequena cheia de frascos e ervas secas — prateleiras atrás do balcão visivelmente vazias em alguns pontos.\nPiso: piso de madeira manchado por poções derramadas.\n\n1. Loja — tem: um balcão de madeira, prateleiras de frascos\n2. Laboratório — tem: um caldeirão pequeno borbulhando sozinho, ervas penduradas\n3. Sala de mistura — tem: uma mesa de mistura, frascos de vidro\n4. Depósito de ingredientes — tem: potes etiquetados, feixes de ervas secas\n5. Sala de experimentos — tem: um caderno aberto, anotações espalhadas", categoria: "ambientes" },
    { id: uid(), titulo: "Sala da Guarda (Cervovale)", texto: "Pequeno posto da guarda da vila, funcional e severo.\nPiso: piso de pedra simples.\n\n1. Recepção — tem: uma mesa, um quadro de avisos na parede\n   🔎 Se investigarem: Achado: \"Aviso da Guarda\" (assinado por Selene, com uma frase acrescentada depois, em letra diferente).\n2. Sala dos guardas — tem: uma mesa, alguns banquinhos\n3. Arsenal — tem: um suporte de lanças e escudos\n   🔎 Se investigarem: Achado: \"Sino da Guarda\", pendurado entre as armas — parece comum até alguém tocá-lo três vezes de madrugada.\n4. Arquivo — tem: pastas de relatórios empilhadas\n   🔎 Se investigarem: Achado: \"Relatório da Noite da Bruxa\".\n5. Sala de mapas — tem: um grande mapa regional, uma mesa\n6. Cela — tem: um catre simples, grades de ferro", categoria: "ambientes" },
    { id: uid(), titulo: "O Poço da Praça (Cervovale)", texto: "Praça central da vila, centrada num poço de pedra antigo — é aqui que as 3 relíquias precisam ser jogadas pra quebrar a maldição.\nPiso: calçamento de pedra irregular.\n\n1. Praça ao redor — tem: calçamento de pedra, um banco\n   🔎 Se investigarem: Achado (se alguém passar a noite ali e prestar atenção): \"Bala que Nunca Derrete\", encontrada entre as pedras.\n2. Boca do poço — tem: a borda de pedra do poço, um balde numa corda\n3. Interior do poço — tem: um poço de pedra descendo na escuridão\n4. Estrutura subterrânea — tem: degraus de pedra antigos, musgo com um brilho fraco", categoria: "ambientes" },
    { id: uid(), titulo: "Acampamento Abandonado (esconderijo de Selene) (Bosque Emaranhado)", texto: "Um pequeno acampamento de exploradores numa clareira — sem paredes, delimitado por troncos caídos. Selene anda usando esse lugar escondida.\nPiso: terra batida e folhas secas, raízes expostas cruzando o chão.\n\n1. Área das fogueiras — tem: uma fogueira apagada há dias, galhos carbonizados\n2. Tenda destruída — tem: uma tenda rasgada, um suporte caído\n   🔎 Se investigarem: Achado: \"Página de Selene\" — confirma que ela está viva.\n3. Área de suprimentos — tem: suprimentos mofados e espalhados\n   🔎 Se investigarem: Achado (se Rui foi salvo e trazido aqui, ou se procurarem rastros dele): \"Bilhete de Rui\".\n4. Clareira — tem: grama rala, pegadas confusas na terra\n5. Trilha de saída — tem: uma trilha estreita de terra, arbustos baixos", categoria: "ambientes" },
    { id: uid(), titulo: "Ruínas Antigas (Bosque Emaranhado)", texto: "Ruínas de pedra cobertas de vegetação, arquitetura antiga parcialmente desmoronada.\nPiso: lajes de pedra rachadas, raízes rompendo o chão em vários pontos.\n\n1. Entrada — tem: colunas quebradas\n2. Salão principal — tem: escombros caídos, piso rachado\n   🔎 Se investigarem: Achado: \"Diário do Explorador\" — relatos de alguém que se perdeu andando em círculos.\n3. Corredor — tem: paredes cobertas de musgo\n4. Câmara do altar — tem: um altar de pedra coberto de musgo\n5. Sala lateral — tem: escombros, uma estátua quebrada\n6. Escadaria — tem: degraus de pedra gastos\n7. Porão — tem: escuridão total, entalhes fracos na parede", categoria: "ambientes" },
    { id: uid(), titulo: "Círculo dos Cogumelos (Bosque Emaranhado)", texto: "Clareira circular perfeita na floresta, sete cogumelos gigantes coloridos formando um anel ao redor de uma pedra ereta — Ashkan está preso lá dentro.\nPiso: grama luminescente salpicada de esporos brilhantes.\n\n1. Floresta externa — tem: árvores densas, samambaias baixas\n2. Círculo de cogumelos — tem: sete cogumelos gigantes de cores diferentes\n3. Pedra de Ashkan — tem: uma pedra ereta entalhada com símbolos arcanos\n   🔎 Se investigarem: Achado (se explorarem ao redor da pedra): \"Chave Sem Fechadura\" — só serve mais tarde, no Baile Eterno.\n4. Área central — tem: esporos brilhantes no chão", categoria: "ambientes" },
    { id: uid(), titulo: "Caverna do Espelho (Bosque Emaranhado)", texto: "Sistema de cavernas úmidas e sinuosas cortadas na rocha, ficando progressivamente mais estranhas e profundas.\nPiso: rocha úmida e escorregadia, poças rasas d'água refletindo luz azul-esverdeada.\n\n1. Entrada — tem: trepadeiras penduradas, rocha úmida\n2. Túnel estreito — tem: estalactites pingando\n3. Câmara dos ecos — tem: paredes de rocha lisas e curvas\n4. Lago subterrâneo — tem: um lago perfeitamente parado e reflexivo\n5. Câmara do espelho — tem: cacos de espelho embutidos na rocha\n   🔎 Se investigarem: Achado: \"Espelho Rachado\" — mostra uma cena que pode acontecer, nunca diga se é o futuro garantido.\n6. Sala de recarga — tem: símbolos gravados brilhando no chão\n7. Câmara profunda — tem: água parada no escuro, uma luz fraca ao fundo\n   🔎 Se investigarem: Achado (bem escondido): \"Receita de Poção\" (de memória) gravada numa pedra.", categoria: "ambientes" },
    { id: uid(), titulo: "Lago da Saudade Eterna (Bosque Emaranhado)", texto: "Lago mágico perfeitamente circular, água cristalina azul-violeta profunda, sem fundo visível — o portal secreto pro Baile Eterno.\nPiso: areia fina na praia, pedras arredondadas nas margens, a própria água como piso central.\n\n1. Margem — tem: pedras lisas ao longo da beira\n   🔎 Se investigarem: Achado: uma \"Fita Vermelha\" presa a um galho — quem segura sente uma lembrança que não é sua.\n2. Praia — tem: areia fina e clara\n3. Área das pedras — tem: pedras planas espalhadas\n4. Água rasa — tem: água clara e parada\n5. Centro do lago — tem: uma luz suave e hipnótica vindo de baixo d'água\n   🔎 Se investigarem: Ativa o portal pro Baile Eterno se quem entrar carregar um item de origem feérica.", categoria: "ambientes" },
    { id: uid(), titulo: "Praça das Fadas (Vale das Bagas)", texto: "Pracinha de vila feérica em escala miniatura, casas esculpidas em cogumelos gigantes ao redor de uma árvore central.\nPiso: terra batida polvilhada de pétalas, pedrinhas arredondadas formando caminhos.\n\n1. Praça — tem: caminhos de pedrinhas, chão coberto de pétalas\n2. Fonte de mel — tem: uma fonte pequena escorrendo mel dourado\n   🔎 Se investigarem: Achado: \"Semente Azul\" caída perto da fonte — só floresce quando alguém diz uma verdade.\n3. Árvore central — tem: um tronco gigante com portas e janelas esculpidas\n4. Mercado — tem: barraquinhas coloridas\n5. Pequeno palco — tem: uma plataforma de madeira improvisada", categoria: "ambientes" },
    { id: uid(), titulo: "Palácio da Rainha Gardênia (Vale das Bagas)", texto: "Palácio esculpido diretamente nas raízes de uma árvore gigantesca ainda viva e florida.\nPiso: madeira polida com veios dourados, tapetes de pétalas prensadas na sala do trono.\n\n1. Entrada — tem: um caminho de pétalas\n2. Salão principal — tem: pilares de madeira entalhada\n3. Sala do trono — tem: um trono de madeira viva coberto de flores\n   🔎 Se investigarem: Achado: placa com \"O Juramento da Colher\" perto do trono.\n4. Arquivo — tem: prateleiras de pergaminhos\n   🔎 Se investigarem: Achado: \"Carta da Rainha Gardênia\" — conta como Dulcineia roubou a Colher de Mel.\n5. Jardim — tem: canteiros internos luminosos\n6. Sala da Colher de Mel — tem: uma vitrine reverente e vazia\n   🔎 Se investigarem: Achado: \"Colher de Madeira\" — uma réplica com a marca \"D\" entalhada.\n7. Quarto da Rainha — tem: uma cama com dossel, tecidos macios\n8. Sala privada — tem: uma mesinha, uma única cadeira", categoria: "ambientes" },
    { id: uid(), titulo: "Mercado das Fadas (Vale das Bagas)", texto: "Pequeno mercado feérico coberto, barracas de madeira e tecido coloridas lado a lado.\nPiso: tábuas de madeira irregulares, tapetes trançados sob cada barraca.\n\n1. Mercado principal — tem: fileiras de barraquinhas\n2. Barracas — tem: toldos remendados\n   🔎 Se investigarem: Achado: \"Bilhete de uma Fada\" avisando sobre o rato que \"sabe seus nomes\".\n3. Loja de ingredientes — tem: potes de ingredientes mágicos empilhados\n4. Loja de poções — tem: frascos brilhando fracamente, pendurados\n5. Área de comerciantes — tem: uma balança, caixotes pequenos", categoria: "ambientes" },
    { id: uid(), titulo: "A Colmeia (Vale das Bagas)", texto: "Colmeia gigante escavada, paredes hexagonais de cera pingando mel espesso demais pra ser natural.\nPiso: cera endurecida e pegajosa, poças de mel em alguns pontos.\n\n1. Entrada — tem: um arco arredondado de cera\n2. Túnel de mel — tem: paredes de favo pingando\n3. Câmara de armazenamento — tem: células cheias de mel empilhadas\n   🔎 Se investigarem: Achado: \"Registro da Colmeia\" — mostra que a produção de mel ficou impossível no outono.\n4. Câmara das abelhas — tem: células hexagonais de cera bem densas\n5. Câmara da rainha — tem: uma plataforma elevada de cera\n6. Túnel lateral — tem: paredes estreitas e pingando\n7. Câmara contaminada — tem: um chão escuro e rachado, indo em direção à toca do Rei Rato\n8. Saída secreta — tem: uma passagem estreita e escondida", categoria: "ambientes" },
    { id: uid(), titulo: "Armazém / Depósito de Comida (Vale das Bagas)", texto: "Armazém subterrâneo de comida das fadas pequenas, convertido de uma antiga toca.\nPiso: terra compactada, restos de cera e mel grudentos em pontos.\n\n1. Entrada — tem: um simples batente de madeira\n2. Depósito de comida — tem: estoques de comida devorados e espalhados\n3. Sala das poções — tem: um miasma colorido pairando no ar\n4. Armaria — tem: suportes de armas enferrujados\n5. Sala das abelhas — tem: prateleiras cobertas de favo de mel\n   🔎 Se investigarem: Achado: \"Receita de Mel\" (das fadas) — cura pequenas corrupções ou ganha confiança das fadas.\n6. Depósito secundário — tem: caixotes empilhados\n7. Entrada dos túneis — tem: uma abertura estreita e escura", categoria: "ambientes" },
    { id: uid(), titulo: "Túneis do Rei Rato (Vale das Bagas)", texto: "Túneis escavados às pressas por garras desesperadas, estreitando e bifurcando sem padrão claro, até uma câmara final maior.\nPiso: terra irregular, poças de mel rançoso e água parada em pontos mais baixos.\n\n1. Entrada — tem: uma abertura escavada estreita\n   🔎 Se investigarem: Achado: \"Pequeno Dente de Rato\" — sussurra \"Ainda lembro\" perto do Rei Rato.\n2. Túnel principal — tem: paredes de terra com marcas de garras\n3. Bifurcação — tem: dois caminhos divergentes\n4. Toca pequena — tem: pelo grudado, restos de comida\n5. Depósito roubado — tem: comida roubada empilhada\n6. Túnel inundado — tem: água parada rasa\n7. Câmara dos ninhos — tem: ninhos tecidos com detritos\n8. Câmara do Rei Rato — tem: uma massa pulsante de formas de rato fundidas — o Rei Rato", categoria: "ambientes" },
    { id: uid(), titulo: "Jardim do Amanhecer (Baile Eterno)", texto: "Jardim de fadas altas suspenso num eterno amanhecer rosado, seis áreas conectadas por caminhos sinuosos.\nPiso: grama aparada com precisão impossível, caminhos de pedra branca polida.\n\n1. Entrada — tem: um portão de jardim ornamentado\n   🔎 Se investigarem: Achado (preso ao portão): \"Convite para o Baile\" — o baile começa ao anoitecer e não termina.\n2. Jardim principal — tem: roseiras perfeitas demais pra serem reais\n3. Fonte — tem: uma fonte de mármore com veios dourados\n4. Gazebo — tem: um gazebo branco rendado\n5. Labirinto de flores — tem: um pequeno labirinto de sebes floridas\n6. Ponte — tem: uma ponte ornamentada sobre um riacho raso", categoria: "ambientes" },
    { id: uid(), titulo: "Salão do Banquete (Baile Eterno)", texto: "Salão de banquete sob um céu eterno de meio-dia, uma mesa impossivelmente longa dominando o centro.\nPiso: mármore polido em tabuleiro dourado e violeta.\n\n1. Entrada — tem: portas duplas douradas e altas\n   🔎 Se investigarem: Achado: \"Manual de Etiqueta do Baile\" — nunca prometa voltar, nunca pergunte há quanto tempo alguém está ali.\n2. Salão principal — tem: uma mesa de banquete impossivelmente longa\n3. Mesas — tem: fileiras de cadeiras de jantar\n   🔎 Se investigarem: Achado: \"Lista de Convidados\" — Élton Élis está listado como \"convidado permanente\".\n4. Mesa dos nobres — tem: uma mesa elevada e elegante\n5. Buffet — tem: bandejas de prata\n   🔎 Se investigarem: Achado: \"Taça do Meio-Dia\" — quem bebe sente felicidade absoluta por minutos, depois esquece por que estava triste.\n6. Área dos músicos — tem: um pequeno palco elevado\n7. Varanda — tem: portas de vidro, flores em vasos", categoria: "ambientes" },
    { id: uid(), titulo: "Corredores do Palácio (Baile Eterno)", texto: "Corredores palacianos com arquitetura sutilmente impossível — perspectivas que não deveriam se encontrar.\nPiso: tapete magenta profundo correndo por todo o comprimento, mármore visível nas bordas.\n\n1. Corredor principal — tem: espelhos emoldurados em ouro\n2. Escadaria — tem: uma escadaria dupla se curvando de formas estranhas\n3. Corredor dos espelhos — tem: espelhos em ângulos estranhos\n4. Galeria — tem: retratos emoldurados de convidados\n5. Corredor privado — tem: um único banco silencioso", categoria: "ambientes" },
    { id: uid(), titulo: "Sala dos Espelhos (Baile Eterno)", texto: "Câmara circular pequena e desorientadora, forrada de espelhos emoldurados de tamanhos variados.\nPiso: mármore negro polido refletindo os espelhos ao redor.\n\n1. Entrada — tem: um arco estreito espelhado\n2. Espelho central — tem: um espelho grande e ornamentado\n3. Espelhos laterais — tem: espelhos menores em ângulos estranhos\n4. Corredor — tem: uma passagem estreita espelhada\n5. Câmara escondida — tem: um pequeno recanto oculto atrás dos espelhos\n   🔎 Se investigarem: Achado: \"Chave Sem Porta\" — uma cadeira vazia e uma carta: \"Eu também procurei a saída.\"", categoria: "ambientes" },
    { id: uid(), titulo: "Grande Salão de Dança (Baile Eterno)", texto: "O salão mais importante do Baile — uma vasta pista de dança circular sob um céu de estrelas artificiais. É aqui que acontece o desafio social do Rei-Elfo.\nPiso: mármore branco-azulado espelhado no centro, tapetes dourados nas bordas.\n\n1. Entrada — tem: portas altas e ornamentadas\n2. Pista de dança — tem: um piso de mármore refletindo luz de estrelas de lugar nenhum\n3. Palco — tem: uma plataforma elevada e vazia\n   🔎 Se investigarem: Achado (escondido perto do palco): \"Máscara de Porcelana\" — quem a usa é visto como quem os outros esperavam encontrar.\n4. Área dos músicos — tem: suportes de instrumento vazios, sem músicos visíveis\n5. Área dos nobres — tem: assentos estofados\n6. Mesa lateral — tem: uma pequena mesa de refresco\n7. Sacada — tem: um mirante elevado com corrimão\n8. Escadaria — tem: uma grande escadaria curva\n   🔎 Se investigarem: Achado: \"Página do Livro do Rei-Elfo\" — \"um reino perfeito não possui amanhã\".", categoria: "ambientes" },
    { id: uid(), titulo: "Ala de Ilayda (Baile Eterno)", texto: "Ala privada e vaidosa do palácio, decoração excessiva e cheia de espelhos e retratos da própria dona. Élton está mantido aqui.\nPiso: tapetes felpudos em tons rosa e dourado sobre madeira escura.\n\n1. Sala de recepção — tem: retratos e espelhos em profusão\n2. Sala privada — tem: uma penteadeira, uma chaise\n3. Biblioteca — tem: pequenas prateleiras de curiosidades\n4. Quarto de hóspedes — tem: uma cama elegante mas fria\n   🔎 Se investigarem: É aqui que Élton fica. Achado: \"Carta de Élton para Maya\" — a letra bate com o bilhete que ela guarda em Cervovale.\n5. Varanda — tem: uma vista de jardim com corrimão", categoria: "ambientes" },
    { id: uid(), titulo: "Entrada da Torre (Torre da Bruxa)", texto: "Base da torre, um portão imponente de açúcar cristalizado levando a um vestíbulo guardado.\nPiso: pedra coberta por uma fina camada pegajosa de açúcar derretido.\n\n1. Portão — tem: um arco de açúcar cristalizado\n2. Vestíbulo — tem: dois construtos de chocolate com hortelã parados como estátuas\n   🔎 Se investigarem: Senha pra passar sem luta: \"Maçapão Maravilhoso\".\n3. Salão dos constructos — tem: paredes cobertas de caramelo escuro\n4. Escadaria — tem: uma escadaria de pedra em espiral\n5. Corredor — tem: uma passagem estreita vitrificada de doce", categoria: "ambientes" },
    { id: uid(), titulo: "Cozinha (Torre da Bruxa)", texto: "Cozinha encantada e perigosamente viva — os utensílios se mexem sozinhos e atacam quem entra sem permissão.\nPiso: ladrilho escorregadio manchado de melado.\n\n1. Cozinha principal — tem: um caldeirão borbulhando sozinho, sem ninguém mexendo\n2. Fogão — tem: um fogão a lenha\n3. Forno — tem: um forno de tijolo grande\n4. Bancada — tem: facas e utensílios animados\n5. Armários — tem: louças empilhadas\n6. Despensa — tem: potes de doces conservados\n7. Passagem do esgoto — tem: uma grade enferrujada no chão, ligando ao Esgoto", categoria: "ambientes" },
    { id: uid(), titulo: "Jardim Mágico (Torre da Bruxa)", texto: "Jardim interno impossivelmente verdejante, salpicado de flores cristalizadas que brilham como vidro. Alistair está preso aqui, oferecendo a Roleta do Chá.\nPiso: grama artificial perfeita demais, caminho de pedrinhas de açúcar.\n\n1. Entrada — tem: um arco florido que parece de vidro\n2. Canteiros — tem: flores cristalizadas e brilhantes\n3. Fonte — tem: uma fonte pequena com glacê de caramelo\n4. Estufa — tem: painéis de vidro, trepadeiras penduradas\n5. Árvore antiga — tem: uma árvore de casca de doce, torta\n6. Estátuas — tem: figuras de doce imóveis\n7. Área de Alistair — tem: uma mesa de chá posta com um coelho de chocolate branco sentado", categoria: "ambientes" },
    { id: uid(), titulo: "Escritório de Dulcineia (Torre da Bruxa)", texto: "Escritório abarrotado de livros sem título, organizados ao redor de uma escrivaninha central.\nPiso: tábuas escuras cobertas por um tapete surrado.\n\n1. Entrada — tem: uma porta pesada de madeira\n2. Escrivaninha — tem: um diário aberto, uma pena\n   🔎 Se investigarem: Achado: \"Página do Diário de Dulcineia\" — \"a alma não é fixa... por que insistem que uma pessoa precisa permanecer a mesma?\"\n3. Estante 1 — tem: livros sem título, escritos à mão\n4. Estante 2 — tem: tomos velhos empilhados\n5. Estante 3 — tem: um livro-armadilha escondido\n   🔎 Se investigarem: Achado (se lerem com cuidado): \"Pequeno Caderno Preto\" — \"se alguém encontrar isto, não destrua o ovo\", sem assinatura.\n6. Armário — tem: gavetas trancadas\n7. Espelho — tem: um espelho alto e ornamentado", categoria: "ambientes" },
    { id: uid(), titulo: "Laboratório de Experimentos (Torre da Bruxa)", texto: "O laboratório mais denso e perigoso da torre, cheio de instrumentos alquímicos.\nPiso: pedra manchada por décadas de derramamentos alquímicos.\n\n1. Entrada — tem: uma porta pesada manchada de produtos químicos\n2. Bancada — tem: frascos, um pilão manchado\n   🔎 Se investigarem: Achado: \"Pena Negra\" — fica quente perto do ovo de dragão.\n3. Mesa de experimentos — tem: um livro de experimentos aberto\n   🔎 Se investigarem: Achado: \"Registro do Experimento\" — \"Experimento 14: sucesso parcial. A consciência permaneceu separada.\"\n4. Círculo mágico — tem: um círculo gravado e brilhante\n5. Estante de frascos — tem: fileiras de frascos etiquetados\n6. Gaiolas — tem: algumas gaiolas pequenas e vazias\n7. Armário — tem: suprimentos alquímicos trancados\n8. Área de experimentação — tem: uma vitrine vazia do tamanho de uma pessoa", categoria: "ambientes" },
    { id: uid(), titulo: "Corredor das Celas (Torre da Bruxa)", texto: "Corredor estreito ladeado por cinco pequenas celas — onde as crianças roubadas dormiram. Atmosfera pesada e silenciosa.\nPiso: pedra fria e nua, palha espalhada dentro das celas.\n\n1. Corredor — tem: um corredor longo e estreito\n2. Cela 1 — tem: desenhos de criança riscados na parede\n3. Cela 2 — tem: um brinquedo pequeno esquecido\n4. Cela 3 — tem: palha espalhada\n5. Cela 4 — tem: marcas de contagem riscadas na parede\n6. Cela 5 — tem: um catre simples\n7. Sala de observação — tem: uma janela estreita, um banquinho\n8. Escada — tem: degraus gastos descendo", categoria: "ambientes" },
    { id: uid(), titulo: "Berçário (Torre da Bruxa)", texto: "Berçário perturbador que mistura ternura e horror, culminando numa plataforma central elevada com o ovo do dragão.\nPiso: tábuas de madeira macia, tapetes felpudos claros manchados de algo escuro.\n\n1. Entrada — tem: um vão de porta arredondado e suave\n2. Área dos berços — tem: uma fileira de berços vazios\n3. Armários — tem: cobertores dobrados\n4. Brinquedos — tem: brinquedos macios espalhados\n5. Parede de desenhos — tem: desenhos de crianças pregados na parede\n   🔎 Se investigarem: Achado: \"Lista de Nomes\" — nomes de crianças desaparecidas, alguns riscados, um circulado várias vezes: Rui Silva.\n6. Área central — tem: um pequeno tapete redondo\n   🔎 Se investigarem: Achado: \"Boneca de Açúcar\" — chora quando perto de alguém já transformado em doce.\n7. Plataforma do ovo — tem: uma plataforma elevada sustentando um ovo gigante que pulsa com calor visível", categoria: "ambientes" },
    { id: uid(), titulo: "Quarto de Dulcineia (Torre da Bruxa)", texto: "Quarto pessoal da bruxa, elegante e perturbador ao mesmo tempo, organizado ao redor de um altar central.\nPiso: tapete espesso vermelho-escuro, tábuas polidas nas bordas.\n\n1. Entrada — tem: uma porta ornamentada\n2. Cama — tem: uma cama com dossel e cortinas escuras\n3. Penteadeira — tem: potes de maquiagem transbordando\n   🔎 Se investigarem: Achado: \"Frasco com Pó Dourado\" — etiqueta \"Memórias — lote 7\", libera uma lembrança se aberto.\n4. Guarda-roupa — tem: um guarda-roupa ornamentado\n5. Baú — tem: um baú pesado e trancado (a chave está na Gosma de Açúcar do dreno)\n   🔎 Se investigarem: Achado dentro do baú: \"Carta Nunca Enviada\" — \"quando o ovo abrir, eles voltarão. Todos. — Dulcineia\".\n6. Estante — tem: alguns livros pessoais\n   🔎 Se investigarem: Achado: \"Instruções do Pingente\" — \"o que for separado deverá encontrar um recipiente.\"\n7. Altar do Pingente — tem: um construto perfeito, parado, com uma luz azul fraca pulsando no peito", categoria: "ambientes" },
    { id: uid(), titulo: "Câmara do Ovo / Topo da Torre (Torre da Bruxa)", texto: "O ponto mais alto da torre, uma câmara cerimonial aberta com vista pra floresta inteira através de janelas altas.\nPiso: pedra polida em espiral levando ao centro cerimonial.\n\n1. Escadaria — tem: a subida final em espiral\n2. Plataforma central — tem: uma plataforma de pedra elevada\n3. Círculo mágico — tem: um anel gravado e brilhante\n4. Altar — tem: um altar de pedra simples\n   🔎 Se investigarem: Achado (perto do altar): \"Anotação Sobre o Ovo\" — \"se as duas coisas acordarem juntas... não sei qual delas nascerá primeiro.\" Pista importante — não entregue cedo.\n5. Janelas — tem: janelas altas e estreitas deixando entrar luar\n6. Ovo do Dragão — tem: um ovo gigante pulsando com calor visível sobre um pedestal", categoria: "ambientes" },
    { id: uid(), titulo: "Esgoto (Torre da Bruxa)", texto: "Sistema de esgoto apertado sob a torre, túneis estreitos e escuros.\nPiso: pedra encharcada e escorregadia, um fio constante de líquido colorido escorrendo pelo centro dos túneis.\n\n1. Entrada externa — tem: uma grade de ferro enferrujada\n2. Túnel — tem: uma passagem estreita e pingando\n3. Bifurcação — tem: dois túneis baixos divergentes\n4. Câmara subterrânea — tem: uma massa disforme no escuro — a Gosma de Açúcar, guardando a chave dourada do baú\n5. Saída para cozinha — tem: uma grade enferrujada no teto, ligando à Cozinha", categoria: "ambientes" },
  ];
  notes.forEach((n) => {
    if (!state.notes.some((x) => x.titulo === n.titulo)) state.notes.push(n);
  });
...
function seedNpcPersonalities() {
  if (state.seededNpcPersonalities) return;
  state.seededNpcPersonalities = true;
  // Personalidade/aparência que já tínhamos escrito, mas só estava no texto
  // corrido da aventura — agora também na ficha de cada NPC (Compêndio), pra não
  // precisar procurar no meio do texto grande na hora da mesa.
  const personalidades = [
    { nome: "Teodoro Éverson", texto: "Teodoro Éverson (62) — Preocupado, atarefado, cauteloso. Homem alto, espichado pelas exigências de governar uma vila que vira doce. Cabelos e barba viraram algodão-doce. Sente-se responsável por ter deixado Selene usar o Espelho Maléfico." },
    { nome: "Baltasar \"Baz\" Hartly", texto: "Baltasar \"Baz\" Hartly (38) — Rabugento, competente, organizado. Guarda que virou líder de fato desde o sumiço de Selene; vira bala azeda de limão." },
    { nome: "Hannah Falcão", texto: "Hannah Falcão (51) — Calorosa, fofoqueira, curiosa. Dona da estalagem, cheira a canela. Sabia que Élton (marido de Maya) sonhava com uma música estranha vinda da floresta antes de sumir, mas não contou a Maya." },
    { nome: "Constança \"Connie\" Oriente", texto: "Constança \"Connie\" Oriente (24) — Impaciente, otimista, direta. Mensageira presa na vila pela maldição, pele virando hortelã listrada. Já tentou fugir várias vezes; foi barrada pelo Cavaleiro. Numa fuga recente, afugentou uma fera enorme com seu canivete de prata." },
    { nome: "Ezequiel \"Zeca\" Grifo", texto: "Ezequiel \"Zeca\" Grifo (52) — Otimista, distraído, energético. Cabelos viraram minhocas de goma coloridas." },
    { nome: "Geraldo Silva", texto: "Geraldo Silva (38) — Vivaz, criativo, generoso. Padeiro, pai de Rui, esteve no ataque original a Dulcineia." },
    { nome: "Rosana \"Rosa\" Águas-Claras", texto: "Rosana \"Rosa\" Águas-Claras (21) — Engenhosa, determinada, persistente. Irmã mais nova de Selene; administra a loja sozinha desde que os pais viraram bolinhos." },
    { nome: "Maya Élis", texto: "Maya Élis (40) — Sóbria, taciturna, saudosa. Ferreira, marido Élton sumiu há 7 anos; acredita que foi levado pelas fadas. Grande conhecedora de fadas (reconhece referências do Rei-Elfo)." },
    { nome: "Ashkan", texto: "Ashkan (~30) — Sincero, introspectivo, afável. Fada alta ponderada, prefere solidão a festas (por isso alvo das peças de Finnegan). Se libertado, mostra como entrar no Baile Eterno, dá bugigangas de origem feérica pra ativar o portal e seu próprio convite não usado. Concede uma bênção: chamá-lo repetindo seu nome 3x. Conhece a Senhora Neves da Corte da Geada e do Pinheiro (mais bondosa do que parece, adora presentes feitos à mão)." },
    { nome: "Castanho", texto: "Castanho (46) — Estoico, desconfiado, cauteloso. Asas amarelas de libélula, leal e calmo em crise. Fraqueza: seu vaga-lume de estimação — qualquer Princesa com animal de estimação o conquista rápido." },
    { nome: "Rainha Gardênia", texto: "Rainha Gardênia (120) — Elegante, cética, prática. Enganada por Dulcineia quando jovem, jurou nunca mais deixar estranhos se aproveitarem de seu povo. Asas de borboleta-monarca." },
    { nome: "Fazendeiro Listra-d'Olmo", texto: "Fazendeiro Listra-d'Olmo (38) — Dedicado, modesto, franco. Asa ferida." },
    { nome: "Élvar", texto: "Élvar (60) — Esmerado, perspicaz, indiferente. Nunca vai à festa, prefere escolher quem vai. Magro, pálido, bigode roxo-vivo. Lenço bordado com estrelas dá a dica do tema atual." },
    { nome: "Senhora Amaris", texto: "Senhora Amaris (Corte da Lua e das Estrelas, ~30) — Bondosa, sagaz, modesta. Pele morena, olhos como estrelas." },
    { nome: "Príncipe Aurélio", texto: "Príncipe Aurélio (Corte do Sol e do Céu, 30s) — Genial, charmoso, reservado. Clássico Príncipe Encantado; por trás da fachada há um lado sincero raramente visto." },
    { nome: "Penélope", texto: "Penélope (30) — Ansiosa, tímida, devotada. Criada e amiga íntima de Amaris; se corteja secretamente com Aurélio." },
    { nome: "Arturo, o Trovador", texto: "Arturo, o Trovador (~40) — Curiosa, teatral, jovial. Sabe tudo sobre todos — muito procurado ou muito evitado, dependendo de quem tem segredos." },
    { nome: "Élton Élis", texto: "Élton Élis (38) — Atordoado, confuso, saudoso. Abençoado com beleza ao nascer, por isso foi alvo de Ilayda. A comida de fada embotou sua personalidade gentil e curiosa." },
    { nome: "Ilayda", texto: "Ilayda (~20) — Egoísta, esnobe, impulsiva. Acredita que deve ter qualquer coisa bonita que deseja, incluindo pessoas." },
    { nome: "Finnegan", texto: "Finnegan (~10) — Leviano, infantil, impulsivo. Valoriza sua liberdade acima de tudo." },
    { nome: "Duquesa Jacinda", texto: "Duquesa Jacinda (Corte da Sombra e da Melancolia, ~40) — Maldosa, crítica, soberba. Intimidadora, hábil em moda/magia/dança." },
    { nome: "Senhora Neves", texto: "Senhora Neves (Corte da Geada e do Pinheiro, ~50) — Reservada, dedicada, nostálgica. Pele quase azul, deixa geada em tudo que toca; ponto fraco por presentes sinceros feitos à mão. Usa uma pulseira de lã tosca, feita e dada por uma antiga tutelada humana, décadas atrás." },
    { nome: "O Rei-Elfo", texto: "O Rei-Elfo (~30) — Enigmático, majestoso, alegre. Veste um conjunto roxo elaborado; sorriso que sugere que sabe algo que você não sabe." },
  ];
  personalidades.forEach(({ nome, texto }) => {
...
function seedAmbientesV3() {
  if (state.seededAmbientesV3) return;
  state.seededAmbientesV3 = true;
  // Acrescenta (d20) nas dicas de investigação de cada cômodo, pra virar um
  // botão de rolagem clicável na hora (linkifyText já faz isso com qualquer dNN no texto).
  const atualizacoes = [
    { titulo: "Prefeitura (Cervovale)", texto: "Casarão de dois andares numa colina, com vista pra vila. Seis cômodos modestos, madeira escura e papel envelhecido.\nPiso: tábuas de madeira escura, um tapete surrado no gabinete principal.\n\n1. Salão de entrada — tem: um quadro de avisos, um banquinho\n2. Gabinete de Teodoro — tem: uma mesa cheia de papéis, uma cadeira alta\n   🔎 Se investigarem (d20): Achado: \"Carta de Selene para Teodoro\", escondida numa gaveta.\n3. Sala de reuniões — tem: uma mesa comprida, cadeiras avulsas\n4. Arquivo — tem: prateleiras de fichas de moradores, uma gaveta trancada\n   🔎 Se investigarem (d20): Achado: \"Lista dos Moradores\".\n5. Depósito — tem: caixotes empilhados, uma lanterna velha\n6. Sala antiga da guarda — tem: um suporte de armas vazio, um mapa desbotado na parede" },
    { titulo: "Padaria do Geraldo (Cervovale)", texto: "Padaria de vila com casa conjugada, calorosa e familiar, cheirando a pão.\nPiso: piso de madeira clara na loja, ladrilho na cozinha.\n\n1. Salão da padaria — tem: um balcão de madeira, uma prateleira com pães\n2. Balcão — tem: uma caixa de dinheiro, uma pequena balança\n3. Cozinha — tem: uma mesa grande de amassar, panelas penduradas\n   🔎 Se investigarem (d20): Achado: \"Receita do Padeiro\" pregada na parede (e a nota de Geraldo sobre o açúcar vermelho que ele não sabe de onde vem).\n4. Área do forno — tem: dois fornos de tijolo, lenha empilhada\n5. Estoque — tem: sacos de farinha, uma prateleira de receitas\n6. Quarto de Rui — tem: uma cama pequena, brinquedos de madeira espalhados\n   🔎 Se investigarem (d20): Achado (se procurarem entre os brinquedos): \"Página do Diário de uma Criança\"." },
    { titulo: "Pousada A Cabra Sorridente (Cervovale)", texto: "Pousada rústica, salão principal com mesas e um corredor lateral levando aos quartos.\nPiso: tábuas largas de madeira escura, tapete redondo trançado perto da lareira.\n\n1. Salão — tem: mesas de madeira, uma lareira de pedra\n2. Recepção / balcão — tem: um sino de mesa, um livro de hóspedes\n3. Cozinha — tem: um fogão, panelas penduradas\n4. Depósito — tem: barris, sacos de suprimentos\n5. Corredor dos quartos — tem: uma fileira de portas, uma única lamparina de parede\n6. Quarto do proprietário — tem: uma cama simples, um guarda-roupa\n7. Quarto genérico de hóspedes — tem: uma cama, um baú pequeno, uma janela" },
    { titulo: "Loja / Armazém de Zeca (Cervovale)", texto: "Armazém de trocas pequeno e desorganizado, prateleiras lotadas até o teto.\nPiso: piso de madeira gasto, coberto por tapetes remendados.\n\n1. Área de vendas — tem: prateleiras de mercadorias variadas, uma mesinha de bugigangas\n2. Balcão — tem: uma caixa registradora antiga, um livro-caixa\n3. Estoque — tem: caixas empilhadas, ferramentas sobrando\n4. Depósito — tem: caixotes vindos da floresta, um armário empoeirado" },
    { titulo: "Ferraria da Maya (Cervovale)", texto: "Ferraria funcional e organizada — o único lugar da vila que parece sob controle.\nPiso: piso de pedra irregular na oficina, tábuas no escritório.\n\n1. Oficina principal — tem: uma bigorna central, ferramentas penduradas\n2. Fornalha — tem: uma fornalha acesa, um fole\n3. Bancada — tem: uma lâmina inacabada, peças espalhadas\n4. Depósito de metais — tem: barras de metal empilhadas, um barril de sobras\n5. Sala de ferramentas — tem: ferramentas na parede, uma pedra de amolar\n6. Pequeno escritório — tem: uma mesa, um xale dobrado numa prateleira\n   🔎 Se investigarem (d20): Achado: \"Bilhete de Maya\" (endereçado a Élton)." },
    { titulo: "Loja de Poções de Rosa (Cervovale)", texto: "Loja pequena cheia de frascos e ervas secas — prateleiras atrás do balcão visivelmente vazias em alguns pontos.\nPiso: piso de madeira manchado por poções derramadas.\n\n1. Loja — tem: um balcão de madeira, prateleiras de frascos\n2. Laboratório — tem: um caldeirão pequeno borbulhando sozinho, ervas penduradas\n3. Sala de mistura — tem: uma mesa de mistura, frascos de vidro\n4. Depósito de ingredientes — tem: potes etiquetados, feixes de ervas secas\n5. Sala de experimentos — tem: um caderno aberto, anotações espalhadas" },
    { titulo: "Sala da Guarda (Cervovale)", texto: "Pequeno posto da guarda da vila, funcional e severo.\nPiso: piso de pedra simples.\n\n1. Recepção — tem: uma mesa, um quadro de avisos na parede\n   🔎 Se investigarem (d20): Achado: \"Aviso da Guarda\" (assinado por Selene, com uma frase acrescentada depois, em letra diferente).\n2. Sala dos guardas — tem: uma mesa, alguns banquinhos\n3. Arsenal — tem: um suporte de lanças e escudos\n   🔎 Se investigarem (d20): Achado: \"Sino da Guarda\", pendurado entre as armas — parece comum até alguém tocá-lo três vezes de madrugada.\n4. Arquivo — tem: pastas de relatórios empilhadas\n   🔎 Se investigarem (d20): Achado: \"Relatório da Noite da Bruxa\".\n5. Sala de mapas — tem: um grande mapa regional, uma mesa\n6. Cela — tem: um catre simples, grades de ferro" },
    { titulo: "O Poço da Praça (Cervovale)", texto: "Praça central da vila, centrada num poço de pedra antigo — é aqui que as 3 relíquias precisam ser jogadas pra quebrar a maldição.\nPiso: calçamento de pedra irregular.\n\n1. Praça ao redor — tem: calçamento de pedra, um banco\n   🔎 Se investigarem (d20): Achado (se alguém passar a noite ali e prestar atenção): \"Bala que Nunca Derrete\", encontrada entre as pedras.\n2. Boca do poço — tem: a borda de pedra do poço, um balde numa corda\n3. Interior do poço — tem: um poço de pedra descendo na escuridão\n4. Estrutura subterrânea — tem: degraus de pedra antigos, musgo com um brilho fraco" },
    { titulo: "Acampamento Abandonado (esconderijo de Selene) (Bosque Emaranhado)", texto: "Um pequeno acampamento de exploradores numa clareira — sem paredes, delimitado por troncos caídos. Selene anda usando esse lugar escondida.\nPiso: terra batida e folhas secas, raízes expostas cruzando o chão.\n\n1. Área das fogueiras — tem: uma fogueira apagada há dias, galhos carbonizados\n2. Tenda destruída — tem: uma tenda rasgada, um suporte caído\n   🔎 Se investigarem (d20): Achado: \"Página de Selene\" — confirma que ela está viva.\n3. Área de suprimentos — tem: suprimentos mofados e espalhados\n   🔎 Se investigarem (d20): Achado (se Rui foi salvo e trazido aqui, ou se procurarem rastros dele): \"Bilhete de Rui\".\n4. Clareira — tem: grama rala, pegadas confusas na terra\n5. Trilha de saída — tem: uma trilha estreita de terra, arbustos baixos" },
    { titulo: "Ruínas Antigas (Bosque Emaranhado)", texto: "Ruínas de pedra cobertas de vegetação, arquitetura antiga parcialmente desmoronada.\nPiso: lajes de pedra rachadas, raízes rompendo o chão em vários pontos.\n\n1. Entrada — tem: colunas quebradas\n2. Salão principal — tem: escombros caídos, piso rachado\n   🔎 Se investigarem (d20): Achado: \"Diário do Explorador\" — relatos de alguém que se perdeu andando em círculos.\n3. Corredor — tem: paredes cobertas de musgo\n4. Câmara do altar — tem: um altar de pedra coberto de musgo\n5. Sala lateral — tem: escombros, uma estátua quebrada\n6. Escadaria — tem: degraus de pedra gastos\n7. Porão — tem: escuridão total, entalhes fracos na parede" },
    { titulo: "Círculo dos Cogumelos (Bosque Emaranhado)", texto: "Clareira circular perfeita na floresta, sete cogumelos gigantes coloridos formando um anel ao redor de uma pedra ereta — Ashkan está preso lá dentro.\nPiso: grama luminescente salpicada de esporos brilhantes.\n\n1. Floresta externa — tem: árvores densas, samambaias baixas\n2. Círculo de cogumelos — tem: sete cogumelos gigantes de cores diferentes\n3. Pedra de Ashkan — tem: uma pedra ereta entalhada com símbolos arcanos\n   🔎 Se investigarem (d20): Achado (se explorarem ao redor da pedra): \"Chave Sem Fechadura\" — só serve mais tarde, no Baile Eterno.\n4. Área central — tem: esporos brilhantes no chão" },
    { titulo: "Caverna do Espelho (Bosque Emaranhado)", texto: "Sistema de cavernas úmidas e sinuosas cortadas na rocha, ficando progressivamente mais estranhas e profundas.\nPiso: rocha úmida e escorregadia, poças rasas d'água refletindo luz azul-esverdeada.\n\n1. Entrada — tem: trepadeiras penduradas, rocha úmida\n2. Túnel estreito — tem: estalactites pingando\n3. Câmara dos ecos — tem: paredes de rocha lisas e curvas\n4. Lago subterrâneo — tem: um lago perfeitamente parado e reflexivo\n5. Câmara do espelho — tem: cacos de espelho embutidos na rocha\n   🔎 Se investigarem (d20): Achado: \"Espelho Rachado\" — mostra uma cena que pode acontecer, nunca diga se é o futuro garantido.\n6. Sala de recarga — tem: símbolos gravados brilhando no chão\n7. Câmara profunda — tem: água parada no escuro, uma luz fraca ao fundo\n   🔎 Se investigarem (d20): Achado (bem escondido): \"Receita de Poção\" (de memória) gravada numa pedra." },
    { titulo: "Lago da Saudade Eterna (Bosque Emaranhado)", texto: "Lago mágico perfeitamente circular, água cristalina azul-violeta profunda, sem fundo visível — o portal secreto pro Baile Eterno.\nPiso: areia fina na praia, pedras arredondadas nas margens, a própria água como piso central.\n\n1. Margem — tem: pedras lisas ao longo da beira\n   🔎 Se investigarem (d20): Achado: uma \"Fita Vermelha\" presa a um galho — quem segura sente uma lembrança que não é sua.\n2. Praia — tem: areia fina e clara\n3. Área das pedras — tem: pedras planas espalhadas\n4. Água rasa — tem: água clara e parada\n5. Centro do lago — tem: uma luz suave e hipnótica vindo de baixo d'água\n   🔎 Se investigarem (d20): Ativa o portal pro Baile Eterno se quem entrar carregar um item de origem feérica." },
    { titulo: "Praça das Fadas (Vale das Bagas)", texto: "Pracinha de vila feérica em escala miniatura, casas esculpidas em cogumelos gigantes ao redor de uma árvore central.\nPiso: terra batida polvilhada de pétalas, pedrinhas arredondadas formando caminhos.\n\n1. Praça — tem: caminhos de pedrinhas, chão coberto de pétalas\n2. Fonte de mel — tem: uma fonte pequena escorrendo mel dourado\n   🔎 Se investigarem (d20): Achado: \"Semente Azul\" caída perto da fonte — só floresce quando alguém diz uma verdade.\n3. Árvore central — tem: um tronco gigante com portas e janelas esculpidas\n4. Mercado — tem: barraquinhas coloridas\n5. Pequeno palco — tem: uma plataforma de madeira improvisada" },
    { titulo: "Palácio da Rainha Gardênia (Vale das Bagas)", texto: "Palácio esculpido diretamente nas raízes de uma árvore gigantesca ainda viva e florida.\nPiso: madeira polida com veios dourados, tapetes de pétalas prensadas na sala do trono.\n\n1. Entrada — tem: um caminho de pétalas\n2. Salão principal — tem: pilares de madeira entalhada\n3. Sala do trono — tem: um trono de madeira viva coberto de flores\n   🔎 Se investigarem (d20): Achado: placa com \"O Juramento da Colher\" perto do trono.\n4. Arquivo — tem: prateleiras de pergaminhos\n   🔎 Se investigarem (d20): Achado: \"Carta da Rainha Gardênia\" — conta como Dulcineia roubou a Colher de Mel.\n5. Jardim — tem: canteiros internos luminosos\n6. Sala da Colher de Mel — tem: uma vitrine reverente e vazia\n   🔎 Se investigarem (d20): Achado: \"Colher de Madeira\" — uma réplica com a marca \"D\" entalhada.\n7. Quarto da Rainha — tem: uma cama com dossel, tecidos macios\n8. Sala privada — tem: uma mesinha, uma única cadeira" },
    { titulo: "Mercado das Fadas (Vale das Bagas)", texto: "Pequeno mercado feérico coberto, barracas de madeira e tecido coloridas lado a lado.\nPiso: tábuas de madeira irregulares, tapetes trançados sob cada barraca.\n\n1. Mercado principal — tem: fileiras de barraquinhas\n2. Barracas — tem: toldos remendados\n   🔎 Se investigarem (d20): Achado: \"Bilhete de uma Fada\" avisando sobre o rato que \"sabe seus nomes\".\n3. Loja de ingredientes — tem: potes de ingredientes mágicos empilhados\n4. Loja de poções — tem: frascos brilhando fracamente, pendurados\n5. Área de comerciantes — tem: uma balança, caixotes pequenos" },
    { titulo: "A Colmeia (Vale das Bagas)", texto: "Colmeia gigante escavada, paredes hexagonais de cera pingando mel espesso demais pra ser natural.\nPiso: cera endurecida e pegajosa, poças de mel em alguns pontos.\n\n1. Entrada — tem: um arco arredondado de cera\n2. Túnel de mel — tem: paredes de favo pingando\n3. Câmara de armazenamento — tem: células cheias de mel empilhadas\n   🔎 Se investigarem (d20): Achado: \"Registro da Colmeia\" — mostra que a produção de mel ficou impossível no outono.\n4. Câmara das abelhas — tem: células hexagonais de cera bem densas\n5. Câmara da rainha — tem: uma plataforma elevada de cera\n6. Túnel lateral — tem: paredes estreitas e pingando\n7. Câmara contaminada — tem: um chão escuro e rachado, indo em direção à toca do Rei Rato\n8. Saída secreta — tem: uma passagem estreita e escondida" },
    { titulo: "Armazém / Depósito de Comida (Vale das Bagas)", texto: "Armazém subterrâneo de comida das fadas pequenas, convertido de uma antiga toca.\nPiso: terra compactada, restos de cera e mel grudentos em pontos.\n\n1. Entrada — tem: um simples batente de madeira\n2. Depósito de comida — tem: estoques de comida devorados e espalhados\n3. Sala das poções — tem: um miasma colorido pairando no ar\n4. Armaria — tem: suportes de armas enferrujados\n5. Sala das abelhas — tem: prateleiras cobertas de favo de mel\n   🔎 Se investigarem (d20): Achado: \"Receita de Mel\" (das fadas) — cura pequenas corrupções ou ganha confiança das fadas.\n6. Depósito secundário — tem: caixotes empilhados\n7. Entrada dos túneis — tem: uma abertura estreita e escura" },
    { titulo: "Túneis do Rei Rato (Vale das Bagas)", texto: "Túneis escavados às pressas por garras desesperadas, estreitando e bifurcando sem padrão claro, até uma câmara final maior.\nPiso: terra irregular, poças de mel rançoso e água parada em pontos mais baixos.\n\n1. Entrada — tem: uma abertura escavada estreita\n   🔎 Se investigarem (d20): Achado: \"Pequeno Dente de Rato\" — sussurra \"Ainda lembro\" perto do Rei Rato.\n2. Túnel principal — tem: paredes de terra com marcas de garras\n3. Bifurcação — tem: dois caminhos divergentes\n4. Toca pequena — tem: pelo grudado, restos de comida\n5. Depósito roubado — tem: comida roubada empilhada\n6. Túnel inundado — tem: água parada rasa\n7. Câmara dos ninhos — tem: ninhos tecidos com detritos\n8. Câmara do Rei Rato — tem: uma massa pulsante de formas de rato fundidas — o Rei Rato" },
    { titulo: "Jardim do Amanhecer (Baile Eterno)", texto: "Jardim de fadas altas suspenso num eterno amanhecer rosado, seis áreas conectadas por caminhos sinuosos.\nPiso: grama aparada com precisão impossível, caminhos de pedra branca polida.\n\n1. Entrada — tem: um portão de jardim ornamentado\n   🔎 Se investigarem (d20): Achado (preso ao portão): \"Convite para o Baile\" — o baile começa ao anoitecer e não termina.\n2. Jardim principal — tem: roseiras perfeitas demais pra serem reais\n3. Fonte — tem: uma fonte de mármore com veios dourados\n4. Gazebo — tem: um gazebo branco rendado\n5. Labirinto de flores — tem: um pequeno labirinto de sebes floridas\n6. Ponte — tem: uma ponte ornamentada sobre um riacho raso" },
    { titulo: "Salão do Banquete (Baile Eterno)", texto: "Salão de banquete sob um céu eterno de meio-dia, uma mesa impossivelmente longa dominando o centro.\nPiso: mármore polido em tabuleiro dourado e violeta.\n\n1. Entrada — tem: portas duplas douradas e altas\n   🔎 Se investigarem (d20): Achado: \"Manual de Etiqueta do Baile\" — nunca prometa voltar, nunca pergunte há quanto tempo alguém está ali.\n2. Salão principal — tem: uma mesa de banquete impossivelmente longa\n3. Mesas — tem: fileiras de cadeiras de jantar\n   🔎 Se investigarem (d20): Achado: \"Lista de Convidados\" — Élton Élis está listado como \"convidado permanente\".\n4. Mesa dos nobres — tem: uma mesa elevada e elegante\n5. Buffet — tem: bandejas de prata\n   🔎 Se investigarem (d20): Achado: \"Taça do Meio-Dia\" — quem bebe sente felicidade absoluta por minutos, depois esquece por que estava triste.\n6. Área dos músicos — tem: um pequeno palco elevado\n7. Varanda — tem: portas de vidro, flores em vasos" },
    { titulo: "Corredores do Palácio (Baile Eterno)", texto: "Corredores palacianos com arquitetura sutilmente impossível — perspectivas que não deveriam se encontrar.\nPiso: tapete magenta profundo correndo por todo o comprimento, mármore visível nas bordas.\n\n1. Corredor principal — tem: espelhos emoldurados em ouro\n2. Escadaria — tem: uma escadaria dupla se curvando de formas estranhas\n3. Corredor dos espelhos — tem: espelhos em ângulos estranhos\n4. Galeria — tem: retratos emoldurados de convidados\n5. Corredor privado — tem: um único banco silencioso" },
    { titulo: "Sala dos Espelhos (Baile Eterno)", texto: "Câmara circular pequena e desorientadora, forrada de espelhos emoldurados de tamanhos variados.\nPiso: mármore negro polido refletindo os espelhos ao redor.\n\n1. Entrada — tem: um arco estreito espelhado\n2. Espelho central — tem: um espelho grande e ornamentado\n3. Espelhos laterais — tem: espelhos menores em ângulos estranhos\n4. Corredor — tem: uma passagem estreita espelhada\n5. Câmara escondida — tem: um pequeno recanto oculto atrás dos espelhos\n   🔎 Se investigarem (d20): Achado: \"Chave Sem Porta\" — uma cadeira vazia e uma carta: \"Eu também procurei a saída.\"" },
    { titulo: "Grande Salão de Dança (Baile Eterno)", texto: "O salão mais importante do Baile — uma vasta pista de dança circular sob um céu de estrelas artificiais. É aqui que acontece o desafio social do Rei-Elfo.\nPiso: mármore branco-azulado espelhado no centro, tapetes dourados nas bordas.\n\n1. Entrada — tem: portas altas e ornamentadas\n2. Pista de dança — tem: um piso de mármore refletindo luz de estrelas de lugar nenhum\n3. Palco — tem: uma plataforma elevada e vazia\n   🔎 Se investigarem (d20): Achado (escondido perto do palco): \"Máscara de Porcelana\" — quem a usa é visto como quem os outros esperavam encontrar.\n4. Área dos músicos — tem: suportes de instrumento vazios, sem músicos visíveis\n5. Área dos nobres — tem: assentos estofados\n6. Mesa lateral — tem: uma pequena mesa de refresco\n7. Sacada — tem: um mirante elevado com corrimão\n8. Escadaria — tem: uma grande escadaria curva\n   🔎 Se investigarem (d20): Achado: \"Página do Livro do Rei-Elfo\" — \"um reino perfeito não possui amanhã\"." },
    { titulo: "Ala de Ilayda (Baile Eterno)", texto: "Ala privada e vaidosa do palácio, decoração excessiva e cheia de espelhos e retratos da própria dona. Élton está mantido aqui.\nPiso: tapetes felpudos em tons rosa e dourado sobre madeira escura.\n\n1. Sala de recepção — tem: retratos e espelhos em profusão\n2. Sala privada — tem: uma penteadeira, uma chaise\n3. Biblioteca — tem: pequenas prateleiras de curiosidades\n4. Quarto de hóspedes — tem: uma cama elegante mas fria\n   🔎 Se investigarem (d20): É aqui que Élton fica. Achado: \"Carta de Élton para Maya\" — a letra bate com o bilhete que ela guarda em Cervovale.\n5. Varanda — tem: uma vista de jardim com corrimão" },
    { titulo: "Entrada da Torre (Torre da Bruxa)", texto: "Base da torre, um portão imponente de açúcar cristalizado levando a um vestíbulo guardado.\nPiso: pedra coberta por uma fina camada pegajosa de açúcar derretido.\n\n1. Portão — tem: um arco de açúcar cristalizado\n2. Vestíbulo — tem: dois construtos de chocolate com hortelã parados como estátuas\n   🔎 Se investigarem (d20): Senha pra passar sem luta: \"Maçapão Maravilhoso\".\n3. Salão dos constructos — tem: paredes cobertas de caramelo escuro\n4. Escadaria — tem: uma escadaria de pedra em espiral\n5. Corredor — tem: uma passagem estreita vitrificada de doce" },
    { titulo: "Cozinha (Torre da Bruxa)", texto: "Cozinha encantada e perigosamente viva — os utensílios se mexem sozinhos e atacam quem entra sem permissão.\nPiso: ladrilho escorregadio manchado de melado.\n\n1. Cozinha principal — tem: um caldeirão borbulhando sozinho, sem ninguém mexendo\n2. Fogão — tem: um fogão a lenha\n3. Forno — tem: um forno de tijolo grande\n4. Bancada — tem: facas e utensílios animados\n5. Armários — tem: louças empilhadas\n6. Despensa — tem: potes de doces conservados\n7. Passagem do esgoto — tem: uma grade enferrujada no chão, ligando ao Esgoto" },
    { titulo: "Jardim Mágico (Torre da Bruxa)", texto: "Jardim interno impossivelmente verdejante, salpicado de flores cristalizadas que brilham como vidro. Alistair está preso aqui, oferecendo a Roleta do Chá.\nPiso: grama artificial perfeita demais, caminho de pedrinhas de açúcar.\n\n1. Entrada — tem: um arco florido que parece de vidro\n2. Canteiros — tem: flores cristalizadas e brilhantes\n3. Fonte — tem: uma fonte pequena com glacê de caramelo\n4. Estufa — tem: painéis de vidro, trepadeiras penduradas\n5. Árvore antiga — tem: uma árvore de casca de doce, torta\n6. Estátuas — tem: figuras de doce imóveis\n7. Área de Alistair — tem: uma mesa de chá posta com um coelho de chocolate branco sentado" },
    { titulo: "Escritório de Dulcineia (Torre da Bruxa)", texto: "Escritório abarrotado de livros sem título, organizados ao redor de uma escrivaninha central.\nPiso: tábuas escuras cobertas por um tapete surrado.\n\n1. Entrada — tem: uma porta pesada de madeira\n2. Escrivaninha — tem: um diário aberto, uma pena\n   🔎 Se investigarem (d20): Achado: \"Página do Diário de Dulcineia\" — \"a alma não é fixa... por que insistem que uma pessoa precisa permanecer a mesma?\"\n3. Estante 1 — tem: livros sem título, escritos à mão\n4. Estante 2 — tem: tomos velhos empilhados\n5. Estante 3 — tem: um livro-armadilha escondido\n   🔎 Se investigarem (d20): Achado (se lerem com cuidado): \"Pequeno Caderno Preto\" — \"se alguém encontrar isto, não destrua o ovo\", sem assinatura.\n6. Armário — tem: gavetas trancadas\n7. Espelho — tem: um espelho alto e ornamentado" },
    { titulo: "Laboratório de Experimentos (Torre da Bruxa)", texto: "O laboratório mais denso e perigoso da torre, cheio de instrumentos alquímicos.\nPiso: pedra manchada por décadas de derramamentos alquímicos.\n\n1. Entrada — tem: uma porta pesada manchada de produtos químicos\n2. Bancada — tem: frascos, um pilão manchado\n   🔎 Se investigarem (d20): Achado: \"Pena Negra\" — fica quente perto do ovo de dragão.\n3. Mesa de experimentos — tem: um livro de experimentos aberto\n   🔎 Se investigarem (d20): Achado: \"Registro do Experimento\" — \"Experimento 14: sucesso parcial. A consciência permaneceu separada.\"\n4. Círculo mágico — tem: um círculo gravado e brilhante\n5. Estante de frascos — tem: fileiras de frascos etiquetados\n6. Gaiolas — tem: algumas gaiolas pequenas e vazias\n7. Armário — tem: suprimentos alquímicos trancados\n8. Área de experimentação — tem: uma vitrine vazia do tamanho de uma pessoa" },
    { titulo: "Corredor das Celas (Torre da Bruxa)", texto: "Corredor estreito ladeado por cinco pequenas celas — onde as crianças roubadas dormiram. Atmosfera pesada e silenciosa.\nPiso: pedra fria e nua, palha espalhada dentro das celas.\n\n1. Corredor — tem: um corredor longo e estreito\n2. Cela 1 — tem: desenhos de criança riscados na parede\n3. Cela 2 — tem: um brinquedo pequeno esquecido\n4. Cela 3 — tem: palha espalhada\n5. Cela 4 — tem: marcas de contagem riscadas na parede\n6. Cela 5 — tem: um catre simples\n7. Sala de observação — tem: uma janela estreita, um banquinho\n8. Escada — tem: degraus gastos descendo" },
    { titulo: "Berçário (Torre da Bruxa)", texto: "Berçário perturbador que mistura ternura e horror, culminando numa plataforma central elevada com o ovo do dragão.\nPiso: tábuas de madeira macia, tapetes felpudos claros manchados de algo escuro.\n\n1. Entrada — tem: um vão de porta arredondado e suave\n2. Área dos berços — tem: uma fileira de berços vazios\n3. Armários — tem: cobertores dobrados\n4. Brinquedos — tem: brinquedos macios espalhados\n5. Parede de desenhos — tem: desenhos de crianças pregados na parede\n   🔎 Se investigarem (d20): Achado: \"Lista de Nomes\" — nomes de crianças desaparecidas, alguns riscados, um circulado várias vezes: Rui Silva.\n6. Área central — tem: um pequeno tapete redondo\n   🔎 Se investigarem (d20): Achado: \"Boneca de Açúcar\" — chora quando perto de alguém já transformado em doce.\n7. Plataforma do ovo — tem: uma plataforma elevada sustentando um ovo gigante que pulsa com calor visível" },
    { titulo: "Quarto de Dulcineia (Torre da Bruxa)", texto: "Quarto pessoal da bruxa, elegante e perturbador ao mesmo tempo, organizado ao redor de um altar central.\nPiso: tapete espesso vermelho-escuro, tábuas polidas nas bordas.\n\n1. Entrada — tem: uma porta ornamentada\n2. Cama — tem: uma cama com dossel e cortinas escuras\n3. Penteadeira — tem: potes de maquiagem transbordando\n   🔎 Se investigarem (d20): Achado: \"Frasco com Pó Dourado\" — etiqueta \"Memórias — lote 7\", libera uma lembrança se aberto.\n4. Guarda-roupa — tem: um guarda-roupa ornamentado\n5. Baú — tem: um baú pesado e trancado (a chave está na Gosma de Açúcar do dreno)\n   🔎 Se investigarem (d20): Achado dentro do baú: \"Carta Nunca Enviada\" — \"quando o ovo abrir, eles voltarão. Todos. — Dulcineia\".\n6. Estante — tem: alguns livros pessoais\n   🔎 Se investigarem (d20): Achado: \"Instruções do Pingente\" — \"o que for separado deverá encontrar um recipiente.\"\n7. Altar do Pingente — tem: um construto perfeito, parado, com uma luz azul fraca pulsando no peito" },
    { titulo: "Câmara do Ovo / Topo da Torre (Torre da Bruxa)", texto: "O ponto mais alto da torre, uma câmara cerimonial aberta com vista pra floresta inteira através de janelas altas.\nPiso: pedra polida em espiral levando ao centro cerimonial.\n\n1. Escadaria — tem: a subida final em espiral\n2. Plataforma central — tem: uma plataforma de pedra elevada\n3. Círculo mágico — tem: um anel gravado e brilhante\n4. Altar — tem: um altar de pedra simples\n   🔎 Se investigarem (d20): Achado (perto do altar): \"Anotação Sobre o Ovo\" — \"se as duas coisas acordarem juntas... não sei qual delas nascerá primeiro.\" Pista importante — não entregue cedo.\n5. Janelas — tem: janelas altas e estreitas deixando entrar luar\n6. Ovo do Dragão — tem: um ovo gigante pulsando com calor visível sobre um pedestal" },
    { titulo: "Esgoto (Torre da Bruxa)", texto: "Sistema de esgoto apertado sob a torre, túneis estreitos e escuros.\nPiso: pedra encharcada e escorregadia, um fio constante de líquido colorido escorrendo pelo centro dos túneis.\n\n1. Entrada externa — tem: uma grade de ferro enferrujada\n2. Túnel — tem: uma passagem estreita e pingando\n3. Bifurcação — tem: dois túneis baixos divergentes\n4. Câmara subterrânea — tem: uma massa disforme no escuro — a Gosma de Açúcar, guardando a chave dourada do baú\n5. Saída para cozinha — tem: uma grade enferrujada no teto, ligando à Cozinha" },
  ];
  atualizacoes.forEach(({ titulo, texto }) => {
    const n = state.notes.find((x) => x.titulo === titulo && x.categoria === "ambientes");
    if (n) n.texto = texto;
  });
}
